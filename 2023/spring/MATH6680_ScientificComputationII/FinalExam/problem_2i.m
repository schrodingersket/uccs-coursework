...
axis([-2 2 -2 2])
print('problem_2i_normal_cloud.png', '-dpng')
...
M = 3*N;
RHS = [zeros(N,1); alpha*ones(N,1); -alpha*ones(N,1); 0; 0; 0];
...
print('problem_2i_interpolant_3d.png', '-dpng')
...
legend()
print('problem_2i_interpolant_2d.png', '-dpng')
